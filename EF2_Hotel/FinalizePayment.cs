    ...
    public partial class FinalizePayment : MetroForm
    {
        ...
        {   
            ...
            try
            {
                ...
                PaymentCardNumber = phoneComboBox.Text;
        ...
        {
            if (phoneComboBox.Text.Substring(0, 1) == "3")
            {
                cardTypeView.Text = "AmericanExpress";
            }
            else if (phoneComboBox.Text.Substring(0, 1) == "4")
            {
                cardTypeView.Text = "Visa";
            }
            else if (phoneComboBox.Text.Substring(0, 1) == "5")
            {
                cardTypeView.Text = "MasterCard";
            }
            else if (phoneComboBox.Text.Substring(0, 1) == "6")
            {
